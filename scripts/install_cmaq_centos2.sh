...
sed -i 's+set CMAQ_HOME = /\[your_install_path\]/+set CMAQ_HOME = '${CMAQ_HOME}'+g' bldit_project.csh
./bldit_project.csh
cd $CMAQ_HOME

sed -i 's+netcdf_c_root_gcc+'$PATH_TO_APPS'/NETCDF+g' config_cmaq.csh
sed -i 's+netcdf_f_directory_path+'$PATH_TO_APPS'/NETCDF+g' config_cmaq.csh
sed -i 's+ioapi_root_gcc+'$PATH_TO_APPS'/IOAPI+g' config_cmaq.csh
sed -i 's+ioapi_inc_gcc+fixed_src+g' config_cmaq.csh
sed -i 's+/ioapi_lib_gcc++g' config_cmaq.csh

sed -i 's+mpi_incl_gcc+/usr/lib64/openmpi/include+g' config_cmaq.csh
sed -i 's+mpi_lib_gcc+/usr/lib64/openmpi/lib+g' config_cmaq.csh

# sed -i 's+ioapi_inc_gcc+'$PATH_TO_APPS'/IOAPI/fixed_src+g' config_cmaq.csh
...
sed -i 's+setenv myLINK_FLAG  # "-fopenmp"+setenv myLINK_FLAG "-fopenmp"+g' config_cmaq.csh
